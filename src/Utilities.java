...
public class Utilities {
	...
	public void mostrarReglasInformacion(int opcion) {
		if (opcion == 2) {
			...
			System.out.println(
					"Los jugadores pueden elegir la opción 'Solicitar ayuda aliada' en lugar de atacar o defender. Esto causará uno de los siguientes efectos de manera aleatoria:");
			...
			System.out.println(
					"   •	República Checa: 20% más de daño realizado y 10% de daño recibido en climas especiales.");
			System.out.println("   •	Italia: Cada 2 rondas genera automáticamente 5 de escudo.");
			System.out.println(
					"   •	Hungría: Si usa todos los recursos para defender se vuelve invulnerable, pero pierde el siguiente turno (no podrá atacar o defender).");
			...
			System.out.println(
					"   •	Dinamarca: Doble de vida, pero empieza con 10 misiles (que se van incrementado en 10 en cada ronda hasta el numero normal de misiles).");
